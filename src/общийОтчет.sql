...
-- WHERE 
--     R.Папки = 35700042 
--     AND KO.[Категории организаций] = 7036
...
-- WHERE 
--     KO.[Категории организаций] = 7036 
--     AND T.[Счет-Наниматель] NOT IN (SELECT R.[Реестры_состав-Лицевой] FROM Реестры R WHERE R.Папки = 35700042)
...
-- WHERE 
--     KO.[Категории организаций] = 7034 
--     AND T.[Счет-Наниматель] IN (SELECT R.[Реестры_состав-Лицевой] FROM Реестры R WHERE R.Папки = 35700042)
